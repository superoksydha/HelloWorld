				...
				if ((((this.pemain).tool).getName() != "hand") && (((this.pemain).tool).getName() != "move")) {
					...
					if (((this.pemain).tool).getName() != "move") {
						switch(this.pemain.getOrient()) {
							case TOP : {
								(TileKandangA)this.mapu[this.pemain.inFrontOf().getX()][this.pemain.inFrontOf().getY()].isi.kickTo((this.mapu[this.pemain.inFrontOf().getX()][this.pemain.inFrontOf().getY()].isi.getLokasi().getX()), (this.mapu[this.pemain.inFrontOf().getX()][this.pemain.inFrontOf().getY()].isi.getLokasi().getY() - 1));
								(TileKandangA)this.mapu[((this.pemain).getCoord()).getX()][((this.pemain).getCoord()).getY() - 2].newHewan(this.mapu[((this.pemain).inFrontOf()).getX()][((this.pemain).inFrontOf()).getY()].isi);
							...
							break;
							case RIGHT : {
								(TileKandangA)this.mapu[this.pemain.inFrontOf().getX()][this.pemain.inFrontOf().getY()].isi.kickTo((this.mapu[this.pemain.inFrontOf().getX()][this.pemain.inFrontOf().getY()].isi.getLokasi().getX()), (this.mapu[this.pemain.inFrontOf().getX() + 1][this.pemain.inFrontOf().getY()].isi.getLokasi().getY()));
								(TileKandangA)this.mapu[((this.pemain).getCoord()).getX() + 2][((this.pemain).getCoord()).getY()].newHewan(this.mapu[((this.pemain).inFrontOf()).getX()][((this.pemain).inFrontOf()).getY()].isi);
								(TileKandangA)this.mapu[((this.pemain).inFrontOf()).getX()][((this.pemain).inFrontOf()).getY()].removeHewan();
							}
							break;
							case LEFT : {
